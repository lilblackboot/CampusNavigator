...
export const HoverImageLinks = ({setActiveTab}) => {
  return (
    <section className="bg-trasparent p-4 md:p-8">
      <div className="mx-auto max-w-5xl">
        <Link
          heading="Assistance"
          subheading="Stay on top of your classes"
          imgSrc="https://images.unsplash.com/photo-1606761568499-6d2451b23c66?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          onClick={()=>setActiveTab('tab1')}
        />
        <Link
          heading="Food"
          subheading="Eliminate your cravings"
          imgSrc="https://plus.unsplash.com/premium_photo-1664702602703-b42d50b90af3?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
...
const Link = ({ heading, imgSrc, subheading, onClick }) => {
